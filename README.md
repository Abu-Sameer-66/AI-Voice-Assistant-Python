<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0f0f0f,1c1c1c,d4af37,8b8000,f5f5f5&height=250&section=header&text=AI%20Voice%20Assistant&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Next-Gen%20OS%20Automation%20%7C%20Powered%20by%20OpenAI&descAlignY=60&descAlign=50" width="100%"/>
</div>
...
<div align="center">
  ...
  <a href="https://github.com/Abu-Sameer-66/AI-Voice-Assistant-Python">
    <img src="https://img.shields.io/badge/Python-3.10+-ef473a?style=for-the-badge&logo=python&logoColor=white"/>
  </a>
  <a href="https://github.com/Abu-Sameer-66/AI-Voice-Assistant-Python">
...
```mermaid
graph TD
    A[🎤 User Voice Input] -->|SpeechRecognition| B(Text-to-Speech Engine)
    B -->|String| C{Wake Word Detected?}
    C -- Yes --> D[🚀 Send to LLM Brain]
    C -- No --> A
    D -->|Context Analysis| E{Intent Classification}
    E -- 'Play Music' --> F[🎵 os.startfile]
